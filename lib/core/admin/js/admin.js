			...
			'<i class="fa fa-check">': function() {
				if($('#fcmsImageSrc').val() !== '') {
					...
					if($image.parent().data('autoimg-params')) {
						autoimg = root + 'autoimg/' + $image.parent().data('autoimg-params') + src;
					}
...
function boxFunctions() {
	$('.box .imageSelect').hide().after('<i class="fa fa-picture-o imageSelectButton"></i> <i class="fa fa-times imageSelectButton"></i>').each(function() {
		if($(this).val() !== '') {
			$(this).after($('<img class="imagePreview" />').attr('src', root + 'upload/media/' + $(this).val()));
		}
	});
	$('.box').on('click', '.imageSelectButton.fa-picture-o', function() {
	...
	$('.box .pageSelect').after('<i class="fa fa-file-o pageSelectButton"></i>');
	$('.box').on('click', '.pageSelectButton.fa-file-o', function() {
		var $input = $(this).siblings('input');
	...
	$('.box ul.repeatable').each(function() {
